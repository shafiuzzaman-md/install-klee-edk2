...
define dso_local i32 @Example1_Driver_LockboxUnload(i8* noundef %0) #0 !dbg !792 {
  ...
  %6 = icmp slt i32 %5, 0, !dbg !797
  br i1 %6, label %7, label %9, !dbg !799

7:                                                ; preds = %1
  %8 = load i32, i32* %4, align 4, !dbg !800
  store i32 %8, i32* %2, align 4, !dbg !802
  br label %11, !dbg !802

9:                                                ; preds = %1
  %10 = load i32, i32* %4, align 4, !dbg !803
  store i32 %10, i32* %2, align 4, !dbg !804
  br label %11, !dbg !804

11:                                               ; preds = %9, %7
  %12 = load i32, i32* %2, align 4, !dbg !805
  ret i32 %12, !dbg !805
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main(i32 noundef %0, i8** noundef %1) #0 !dbg !806 {
  ...
  call void @llvm.dbg.declare(metadata i32* %4, metadata !812, metadata !DIExpression()), !dbg !813
  ...
  call void @llvm.dbg.declare(metadata %struct.EFI_SYSTEM_TABLE** %7, metadata !818, metadata !DIExpression()), !dbg !819
  %8 = bitcast i8** %6 to i8*, !dbg !820
  call void @klee_make_symbolic(i8* noundef %8, i64 noundef 8, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i64 0, i64 0)), !dbg !821
  %9 = bitcast %struct.EFI_SYSTEM_TABLE** %7 to i8*, !dbg !822
  call void @klee_make_symbolic(i8* noundef %9, i64 noundef 8, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i64 0, i64 0)), !dbg !823
  %10 = load i8*, i8** %6, align 8, !dbg !824
  %11 = load %struct.EFI_SYSTEM_TABLE*, %struct.EFI_SYSTEM_TABLE** %7, align 8, !dbg !825
  %12 = call i32 @Example1_Driver_LockboxInit(i8* noundef %10, %struct.EFI_SYSTEM_TABLE* noundef %11), !dbg !826
  ret i32 0, !dbg !827
}
...
!3 = !DIFile(filename: "Example1_Driver_Lockbox.c", directory: "/home/hira/Research/HARDEN/harden/Example1/edk2/EmulatorPkg/Example1_Driver_Lockbox", checksumkind: CSK_MD5, checksum: "f7a1087e3b512cf29a2b66f007473f10")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!797 = !DILocation(line: 104, column: 7, scope: !798)
!798 = distinct !DILexicalBlock(scope: !792, file: !3, line: 104, column: 7)
!799 = !DILocation(line: 104, column: 7, scope: !792)
!800 = !DILocation(line: 105, column: 12, scope: !801)
!801 = distinct !DILexicalBlock(scope: !798, file: !3, line: 104, column: 27)
!802 = !DILocation(line: 105, column: 5, scope: !801)
!803 = !DILocation(line: 108, column: 10, scope: !792)
!804 = !DILocation(line: 108, column: 3, scope: !792)
!805 = !DILocation(line: 109, column: 1, scope: !792)
!806 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 191, type: !807, scopeLine: 191, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !115)
!807 = !DISubroutineType(types: !808)
!808 = !{!62, !62, !809}
!809 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !810, size: 64)
!810 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !811, size: 64)
!811 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!812 = !DILocalVariable(name: "argc", arg: 1, scope: !806, file: !3, line: 191, type: !62)
!813 = !DILocation(line: 191, column: 14, scope: !806)
!814 = !DILocalVariable(name: "argv", arg: 2, scope: !806, file: !3, line: 191, type: !809)
!815 = !DILocation(line: 191, column: 27, scope: !806)
!816 = !DILocalVariable(name: "ImageHandle", scope: !806, file: !3, line: 192, type: !83)
!817 = !DILocation(line: 192, column: 19, scope: !806)
!818 = !DILocalVariable(name: "SystemTable", scope: !806, file: !3, line: 193, type: !252)
!819 = !DILocation(line: 193, column: 20, scope: !806)
!820 = !DILocation(line: 196, column: 22, scope: !806)
!821 = !DILocation(line: 196, column: 3, scope: !806)
!822 = !DILocation(line: 197, column: 22, scope: !806)
!823 = !DILocation(line: 197, column: 3, scope: !806)
!824 = !DILocation(line: 199, column: 31, scope: !806)
!825 = !DILocation(line: 199, column: 44, scope: !806)
!826 = !DILocation(line: 199, column: 3, scope: !806)
!827 = !DILocation(line: 201, column: 5, scope: !806)
