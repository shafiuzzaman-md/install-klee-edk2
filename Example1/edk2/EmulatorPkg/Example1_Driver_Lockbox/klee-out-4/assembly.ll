...
define dso_local i32 @Example1_Driver_LockboxInit(i8* noundef %0, %struct.EFI_SYSTEM_TABLE* noundef %1) #0 !dbg !249 {
  ...
  %12 = call zeroext i8 @DebugAssertEnabled(), !dbg !771
  %13 = icmp ne i8 %12, 0, !dbg !771
  %14 = load i32, i32* %5, align 4
  %15 = icmp slt i32 %14, 0
  %or.cond = select i1 %13, i1 %15, i1 false, !dbg !774
  br i1 %or.cond, label %16, label %25, !dbg !774

16:                                               ; preds = %2
  %17 = call zeroext i8 @DebugPrintEnabled(), !dbg !775
  %18 = icmp ne i8 %17, 0, !dbg !775
  br i1 %18, label %19, label %24, !dbg !781

19:                                               ; preds = %16
  %20 = call zeroext i8 @DebugPrintLevelEnabled(i32 noundef -2147483648), !dbg !782
  %21 = icmp ne i8 %20, 0, !dbg !782
  br i1 %21, label %22, label %24, !dbg !786

22:                                               ; preds = %19
  %23 = load i32, i32* %5, align 4, !dbg !787
  call void (i32, i8*, ...) @DebugPrint(i32 noundef -2147483648, i8* noundef getelementptr inbounds ([33 x i8], [33 x i8]* @.str, i64 0, i64 0), i32 noundef %23), !dbg !787
  br label %24, !dbg !787

24:                                               ; preds = %16, %19, %22
  call void @DebugAssert(i8* noundef getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([39 x i8], [39 x i8]* @.str.2, i64 0, i64 0)), !dbg !789
  br label %25, !dbg !789

25:                                               ; preds = %2, %24
  %26 = load i32, i32* %5, align 4, !dbg !790
  ret i32 %26, !dbg !791
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @Example1_Driver_LockboxUnload(i8* noundef %0) #0 !dbg !792 {
  %2 = alloca i32, align 4
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
  store i8* %0, i8** %3, align 8
  call void @llvm.dbg.declare(metadata i8** %3, metadata !793, metadata !DIExpression()), !dbg !794
  call void @llvm.dbg.declare(metadata i32* %4, metadata !795, metadata !DIExpression()), !dbg !796
  store i32 0, i32* %4, align 4, !dbg !796
  %5 = load %struct.EFI_BOOT_SERVICES*, %struct.EFI_BOOT_SERVICES** @gBS, align 8, !dbg !797
  %6 = getelementptr inbounds %struct.EFI_BOOT_SERVICES, %struct.EFI_BOOT_SERVICES* %5, i32 0, i32 4, !dbg !798
  %7 = load i32 (i64, i32)*, i32 (i64, i32)** %6, align 8, !dbg !798
  %8 = load i64, i64* @PhysicalBuffer, align 8, !dbg !799
  %9 = load i32, i32* @Pages, align 4, !dbg !800
  %10 = call i32 %7(i64 noundef %8, i32 noundef %9), !dbg !797
  store i32 %10, i32* %4, align 4, !dbg !801
  %11 = load i32, i32* %4, align 4, !dbg !802
  %12 = icmp slt i32 %11, 0, !dbg !802
  br i1 %12, label %13, label %15, !dbg !804

13:                                               ; preds = %1
  %14 = load i32, i32* %4, align 4, !dbg !805
  store i32 %14, i32* %2, align 4, !dbg !807
  br label %17, !dbg !807

15:                                               ; preds = %1
  %16 = load i32, i32* %4, align 4, !dbg !808
  store i32 %16, i32* %2, align 4, !dbg !809
  br label %17, !dbg !809

17:                                               ; preds = %15, %13
  %18 = load i32, i32* %2, align 4, !dbg !810
  ret i32 %18, !dbg !810
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main(i32 noundef %0, i8** noundef %1) #0 !dbg !811 {
  ...
  call void @llvm.dbg.declare(metadata i32* %4, metadata !817, metadata !DIExpression()), !dbg !818
  store i8** %1, i8*** %5, align 8
  call void @llvm.dbg.declare(metadata i8*** %5, metadata !819, metadata !DIExpression()), !dbg !820
  call void @llvm.dbg.declare(metadata i8** %6, metadata !821, metadata !DIExpression()), !dbg !822
  call void @llvm.dbg.declare(metadata %struct.EFI_SYSTEM_TABLE** %7, metadata !823, metadata !DIExpression()), !dbg !824
  %8 = bitcast i8** %6 to i8*, !dbg !825
  call void @klee_make_symbolic(i8* noundef %8, i64 noundef 8, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i64 0, i64 0)), !dbg !826
  %9 = bitcast %struct.EFI_SYSTEM_TABLE** %7 to i8*, !dbg !827
  call void @klee_make_symbolic(i8* noundef %9, i64 noundef 8, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i64 0, i64 0)), !dbg !828
  %10 = load i8*, i8** %6, align 8, !dbg !829
  %11 = load %struct.EFI_SYSTEM_TABLE*, %struct.EFI_SYSTEM_TABLE** %7, align 8, !dbg !830
  %12 = call i32 @Example1_Driver_LockboxInit(i8* noundef %10, %struct.EFI_SYSTEM_TABLE* noundef %11), !dbg !831
  ret i32 0, !dbg !832
}
...
!3 = !DIFile(filename: "Example1_Driver_Lockbox.c", directory: "/home/hira/Research/HARDEN/harden/Example1/edk2/EmulatorPkg/Example1_Driver_Lockbox", checksumkind: CSK_MD5, checksum: "04a0bf5c9bd30b6c30a88ba0f2a48533")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!771 = !DILocation(line: 80, column: 3, scope: !772)
!772 = distinct !DILexicalBlock(scope: !773, file: !3, line: 80, column: 3)
!773 = distinct !DILexicalBlock(scope: !249, file: !3, line: 80, column: 3)
!774 = !DILocation(line: 80, column: 3, scope: !773)
!775 = !DILocation(line: 80, column: 3, scope: !776)
!776 = distinct !DILexicalBlock(scope: !777, file: !3, line: 80, column: 3)
!777 = distinct !DILexicalBlock(scope: !778, file: !3, line: 80, column: 3)
!778 = distinct !DILexicalBlock(scope: !779, file: !3, line: 80, column: 3)
!779 = distinct !DILexicalBlock(scope: !780, file: !3, line: 80, column: 3)
!780 = distinct !DILexicalBlock(scope: !772, file: !3, line: 80, column: 3)
!781 = !DILocation(line: 80, column: 3, scope: !777)
!782 = !DILocation(line: 80, column: 3, scope: !783)
!783 = distinct !DILexicalBlock(scope: !784, file: !3, line: 80, column: 3)
!784 = distinct !DILexicalBlock(scope: !785, file: !3, line: 80, column: 3)
!785 = distinct !DILexicalBlock(scope: !776, file: !3, line: 80, column: 3)
!786 = !DILocation(line: 80, column: 3, scope: !784)
!787 = !DILocation(line: 80, column: 3, scope: !788)
!788 = distinct !DILexicalBlock(scope: !783, file: !3, line: 80, column: 3)
!789 = !DILocation(line: 80, column: 3, scope: !778)
!790 = !DILocation(line: 82, column: 10, scope: !249)
!791 = !DILocation(line: 82, column: 3, scope: !249)
!792 = distinct !DISubprogram(name: "Example1_Driver_LockboxUnload", scope: !3, file: !3, line: 94, type: !640, scopeLine: 97, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !115)
!793 = !DILocalVariable(name: "ImageHandle", arg: 1, scope: !792, file: !3, line: 95, type: !83)
!794 = !DILocation(line: 95, column: 18, scope: !792)
!795 = !DILocalVariable(name: "Status", scope: !792, file: !3, line: 98, type: !81)
!796 = !DILocation(line: 98, column: 14, scope: !792)
!797 = !DILocation(line: 103, column: 12, scope: !792)
!798 = !DILocation(line: 103, column: 17, scope: !792)
!799 = !DILocation(line: 103, column: 28, scope: !792)
!800 = !DILocation(line: 103, column: 44, scope: !792)
!801 = !DILocation(line: 103, column: 10, scope: !792)
!802 = !DILocation(line: 104, column: 7, scope: !803)
!803 = distinct !DILexicalBlock(scope: !792, file: !3, line: 104, column: 7)
!804 = !DILocation(line: 104, column: 7, scope: !792)
!805 = !DILocation(line: 105, column: 12, scope: !806)
!806 = distinct !DILexicalBlock(scope: !803, file: !3, line: 104, column: 27)
!807 = !DILocation(line: 105, column: 5, scope: !806)
!808 = !DILocation(line: 108, column: 10, scope: !792)
!809 = !DILocation(line: 108, column: 3, scope: !792)
!810 = !DILocation(line: 109, column: 1, scope: !792)
!811 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 191, type: !812, scopeLine: 191, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !115)
!812 = !DISubroutineType(types: !813)
!813 = !{!62, !62, !814}
!814 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !815, size: 64)
!815 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !816, size: 64)
!816 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!817 = !DILocalVariable(name: "argc", arg: 1, scope: !811, file: !3, line: 191, type: !62)
!818 = !DILocation(line: 191, column: 14, scope: !811)
!819 = !DILocalVariable(name: "argv", arg: 2, scope: !811, file: !3, line: 191, type: !814)
!820 = !DILocation(line: 191, column: 27, scope: !811)
!821 = !DILocalVariable(name: "ImageHandle", scope: !811, file: !3, line: 192, type: !83)
!822 = !DILocation(line: 192, column: 19, scope: !811)
!823 = !DILocalVariable(name: "SystemTable", scope: !811, file: !3, line: 193, type: !252)
!824 = !DILocation(line: 193, column: 20, scope: !811)
!825 = !DILocation(line: 196, column: 22, scope: !811)
!826 = !DILocation(line: 196, column: 3, scope: !811)
!827 = !DILocation(line: 197, column: 22, scope: !811)
!828 = !DILocation(line: 197, column: 3, scope: !811)
!829 = !DILocation(line: 199, column: 31, scope: !811)
!830 = !DILocation(line: 199, column: 44, scope: !811)
!831 = !DILocation(line: 199, column: 3, scope: !811)
!832 = !DILocation(line: 201, column: 5, scope: !811)
